...
class Mouchard : public T
{
  ...
  public:
    ...
    Mouchard(X&& x, PACK&&... pack)
      : T(std::forward<X>(x), std::forward<PACK...>(pack...))
    {
        ++nbConstruction_;
    }
...
//-------------------------------------------------------------------------------Attributs statiques
template<class T>
unsigned long Mouchard<T>::nbAffectation_ = 0;
template<class T>
unsigned long Mouchard<T>::nbConstruction_ = 0;
template<class T>
unsigned long Mouchard<T>::nbCopie_ = 0;
template<class T>
unsigned long Mouchard<T>::nbMouvement_ = 0;
